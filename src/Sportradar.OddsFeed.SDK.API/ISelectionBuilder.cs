...
namespace Sportradar.OddsFeed.SDK.API
{
    ...
    public interface ISelectionBuilder
    {
        ...
        /// <returns>The <see cref="ISelectionBuilder"/> instance used to set additional values.</returns>
        ISelectionBuilder SetEventId(URN eventId);
        ...
        /// <returns>The <see cref="ISelectionBuilder"/> instance used to set additional values.</returns>
        ISelectionBuilder SetMarketId(int marketId);
        ...
        /// <returns>The <see cref="ISelectionBuilder"/> instance used to set additional values.</returns>
        ISelectionBuilder SetSpecifiers(string specifiers);
        ...
        /// <returns>The <see cref="ISelectionBuilder"/> instance used to set additional values.</returns>
        ISelectionBuilder SetOutcomeId(string outcomeId);
