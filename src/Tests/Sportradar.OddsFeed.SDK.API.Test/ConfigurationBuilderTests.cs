...
namespace Sportradar.OddsFeed.SDK.API.Test
{
    ...
    public class ConfigurationBuilderTests
    {
        ...
        public void httpClientTimeout_has_correct_value()
        {
            ...
            Assert.AreEqual(_testSection.HttpClientTimeout, StageBuilder(_testSection).Build().HttpClientTimeout);
        ...
        public void min_interval_between_recovery_requests_has_correct_value()
        {
            ...
            Assert.AreEqual(_testSection.MinIntervalBetweenRecoveryRequests, StageBuilder(_testSection).Build().MinIntervalBetweenRecoveryRequests);
            ...
            Assert.AreEqual(140, StageBuilder(_testSection).SetMinIntervalBetweenRecoveryRequests(140).Build().MinIntervalBetweenRecoveryRequests);
            ...
            Assert.AreEqual(SdkInfo.DefaultIntervalBetweenRecoveryRequests, StageBuilder("token").SetDefaultLanguage(TestData.Culture).Build().MinIntervalBetweenRecoveryRequests);
            ...
            Assert.AreEqual(_testSection.MinIntervalBetweenRecoveryRequests, StageBuilder(_testSection).SetMinIntervalBetweenRecoveryRequests(140).LoadFromConfigFile().Build().MinIntervalBetweenRecoveryRequests);
