...
public class ScheduleData
{
    ...
    public readonly IMatchV4 Match;
    ...
    public ScheduleData(TestSportEntityFactoryBuilder sportEntityFactoryBuilder,
                        ITestOutputHelper outputHelper,
                        ExceptionHandlingStrategy throwingStrategy = ExceptionHandlingStrategy.THROW)
    {
