...
namespace Sportradar.OddsFeed.SDK.Test.Shared
{
    internal class TestSportEntityFactory : ISportEntityFactory
    {
        ...
        public async Task<IEnumerable<IPlayer>> BuildPlayersAsync(IReadOnlyCollection<URN> playersIds,
                                                                  ...
                                                                  ExceptionHandlingStrategy exceptionStrategy)
        {
            ...
            foreach (var playersId in playersIds)
            {
                ...
                {
                    Debug.WriteLine($"No player for {playersId}");
                }
            }
        ...
        public ICompetitor BuildCompetitor(CompetitorCI competitorCI,
                                           IReadOnlyCollection<CultureInfo> cultures,
        ...
        public ITeamCompetitor BuildTeamCompetitor(TeamCompetitorCI teamCompetitorCI,
                                                   IReadOnlyCollection<CultureInfo> cultures,
                                                   ICompetitionCI rootCompetitionCI,
                                                   ExceptionHandlingStrategy exceptionStrategy)
        {
        ...
        public Task<ICompetitor> BuildCompetitorAsync(URN competitorId,
                                                      IReadOnlyCollection<CultureInfo> cultures,
                                                      ICompetitionCI rootCompetitionCI,
                                                      ExceptionHandlingStrategy exceptionStrategy)
        {
            var competitor = new Competitor(competitorId,
                                            _profileCache,
                                            cultures,
                                            this,
                                            exceptionStrategy,
                                            rootCompetitionCI.GetCompetitorsReferencesAsync().GetAwaiter().GetResult());
        ...
        public Task<ITeamCompetitor> BuildTeamCompetitorAsync(URN teamCompetitorId,
                                                              IReadOnlyCollection<CultureInfo> cultures,
                                                              ICompetitionCI rootCompetitionCI,
                                                              ExceptionHandlingStrategy exceptionStrategy)
        {
