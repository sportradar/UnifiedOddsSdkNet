...
namespace Sportradar.OddsFeed.SDK.Test.Shared
{
    public class ScheduleData
    {
        ...
        public readonly IMatchV3 Match;
        ...
        public ScheduleData(TestSportEntityFactoryBuilder sportEntityFactoryBuilder, ExceptionHandlingStrategy throwingStrategy = ExceptionHandlingStrategy.THROW)
        {
        ...
        public IMatchV3 GetMatch()
        {
            ...
            var matchCi = new MatchCI(matchDtoEn,
                                      SportEntityFactoryBuilder.DataRouterManager,
                                      new SemaphorePool(500, ThrowingStrategy),
                                      CultureEn,
                                      CultureEn,
                                      new MemoryCache("fixture"));
            ...
            //match.Setup(m => m.GetCompetitorIdsAsync(It.IsAny<CultureInfo>())).ReturnsAsync(matchCi.Competitors);
            ...
            //TODO - revert when interfaces merged
        ...
        public ICompetitor GetCompetitor(URN competitorId)
        {
            ...
            var competitor = new Mock<ICompetitorV6>();
        ...
        private ITeamCompetitor GetTeamCompetitorFromCompetition(TeamCompetitorDTO teamCompetitorEn,
                                                                 TeamCompetitorDTO teamCompetitorDe,
                                                                 TeamCompetitorDTO teamCompetitorHu,
                                                                 ICompetitionCI rootCompetitionCI)
        {
            ...
            return new TeamCompetitor(teamCompetitorCI,
                                      Cultures3,
                                      SportEntityFactoryBuilder.SportEntityFactory,
                                      ThrowingStrategy,
        ...
        private static async Task<MatchDTO> XmlParseSummaryAsync(URN id, CultureInfo culture)
        {
            ...
            using (var stream = FileHelper.GetResource(resourceName))
            {
                if (stream != null)
                {

                    var restDeserializer = new Deserializer<Messages.REST.RestMessage>();
