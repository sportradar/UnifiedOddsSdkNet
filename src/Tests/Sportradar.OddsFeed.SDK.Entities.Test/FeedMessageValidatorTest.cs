...
namespace Sportradar.OddsFeed.SDK.Entities.Test
{
    ...
    public class FeedMessageValidatorTest
    {
        ...
        public void Init()
        {
            ...
            var betStopReasonsCache = new NamedValueCache(new NamedValueDataProvider(FileHelper.FindFile("betstop_reasons.xml"), dataFetcher, "betstop_reason"), ExceptionHandlingStrategy.THROW, "BetstopReasons");

            var bettingStatusCache = new NamedValueCache(new NamedValueDataProvider(FileHelper.FindFile("betting_status.xml"), dataFetcher, "betting_status"), ExceptionHandlingStrategy.THROW, "BettingStatus");
        ...
        public void AliveIsCorrectlyValidated()
        {
            ...
            Assert.AreEqual(ValidationResult.ProblemsDetected, _validator.Validate(alive), "Validation of subscribed should fail");
        }
        ...
        public void FixtureChangeIsCorrectlyValidated()
        {
            ...
            Assert.AreEqual(ValidationResult.ProblemsDetected, _validator.Validate(fixtureChange), "Validation of change_type should cause problems");
        }
        ...
        public void BetCancelIsCorrectlyValidated()
        {
            ...
            Assert.AreEqual(ValidationResult.ProblemsDetected, _validator.Validate(betCancel), "Validation of specifiers should cause problems");
        ...
        public void RollbackBetCancelIsCorrectlyValidated()
        {
            ...
            Assert.AreEqual(ValidationResult.ProblemsDetected, _validator.Validate(rollbackCancel), "Validation of specifiers should cause problems");
        ...
        public void BetSettlementIsCorrectlyValidated()
        {
            ...
            Assert.AreEqual(ValidationResult.ProblemsDetected, _validator.Validate(settlement), "Validation of specifiers should cause problems");
        ...
        public void RollbackBetSettlementIsCorrectlyValidated()
        {
            ...
            Assert.AreEqual(ValidationResult.ProblemsDetected, _validator.Validate(rollback), "Validation of specifiers should cause problems");
        ...
        public void OddsChangeIssuesIsCorrectlyValidated()
        {
            ...
            Assert.AreEqual(ValidationResult.ProblemsDetected, _validator.Validate(oddsChange), "Validation of odds_change_reason should cause problems");
            ...
            Assert.AreEqual(ValidationResult.ProblemsDetected, _validator.Validate(oddsChange), "Validation of betstop_reason should cause problems");

            oddsChange = GetMessage<odds_change>("odds_change.xml");
            oddsChange.odds.betting_status = 100;
            oddsChange.odds.betting_statusSpecified = true;
            Assert.AreEqual(ValidationResult.ProblemsDetected, _validator.Validate(oddsChange), "Validation of betting_status should cause problems");
            ...
            Assert.AreEqual(ValidationResult.ProblemsDetected, _validator.Validate(oddsChange), "Validation of outcome[0].active should cause problems");

            oddsChange = GetMessage<odds_change>("odds_change.xml");
            oddsChange.odds.market.First().specifiers = "some_specifiers";
            Assert.AreEqual(ValidationResult.ProblemsDetected, _validator.Validate(oddsChange), "Validation of specifiers should cause problems");
