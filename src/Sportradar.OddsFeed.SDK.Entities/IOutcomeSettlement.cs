...
namespace Sportradar.OddsFeed.SDK.Entities
{
    ...
    public interface IOutcomeSettlement : IOutcome
    {
        ...
        /// <summary>
        /// Gets the <see cref="VoidFactor"/> associated with a current <see cref="IOutcomeSettlement"/> or a null reference. The value indicates the percentage of the stake that should be voided (returned to the punter).
        /// </summary>
