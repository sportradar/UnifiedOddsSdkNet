...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal
{
    internal static class LanguageHelper
    {
        ...
        /// <returns>A <see cref="ICollection{T}"/> containing missing cultures or a empty list if no cultures are missing</returns>
        public static ICollection<CultureInfo> GetMissingCultures(IEnumerable<CultureInfo> wantedCultures, IEnumerable<CultureInfo> alreadyUsedCultures)
        {
