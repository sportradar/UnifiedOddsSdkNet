...
namespace Sportradar.OddsFeed.SDK.Entities.REST.Internal.Caching.CI
{
    ...
    public class CompetitorCI : SportEntityCI, IExportableCI
    {
        ...
        /// <summary>
        /// The list of CultureInfo and time when competitor profiles where fetched
        /// </summary>
        ...
        /// </summary>
        /// <param name="playerCompetitor">A <see cref="PlayerCompetitorDTO"/> containing information about the competitor</param>
        /// <param name="culture">A <see cref="CultureInfo"/> specifying the language of the passed dto</param>
